...
function register_ocean_portfolio() {
    ...
    $labels = array( 
        'name' => __( 'All Projects', 'ot-portfolio' ),
        'singular_name' => __( 'Projects', 'ot-portfolio' ),
        'add_new' => __( 'Add Projects', 'ot-portfolio' ),
        'add_new_item' => __( 'Add new Projects', 'ot-portfolio' ),
        'edit_item' => __( 'Edit Projects', 'ot-portfolio' ),
        'new_item' => __( 'Add new Projects', 'ot-portfolio' ),
		'all_items' => __('All Projects','ot-portfolio'),
        'view_item' => __( 'View Projects', 'ot-portfolio' ),
        'search_items' => __( 'Search Projects', 'ot-portfolio' ),
        'not_found' => __( 'No Projects found..', 'ot-portfolio' ),
        'not_found_in_trash' => __( 'No Projects found in Trash', 'ot-portfolio' ),
        'parent_item_colon' => __( 'Parent Projects:', 'ot-portfolio' ),
        'menu_name' => __( 'Projects', 'ot-portfolio' ),
    );

    $args = array( 
        'labels' => $labels,
        'hierarchical' => false,
        'description' => __( 'List Projects', 'ot-portfolio' ),
