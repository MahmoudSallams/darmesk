...
add_action( 'tgmpa_register', 'namos_register_required_plugins' );
function namos_register_required_plugins() {
    $protocol = is_ssl() ? 'http' : 'http';
	$plugins = array(
		// This is an example of how to include a plugin from the WordPress Plugin Repository.		
		array(
            'name'               => esc_html__( 'Meta Box', 'namos'),
            'slug'               => 'meta-box',
            'required'           => true,
		...
		array(
            'name'      => esc_html__( 'Contact Form 7', 'namos'),
            'slug'      => 'contact-form-7',
            'required'  => false,
        ),	 
		array(            
            'name'               => esc_html__( 'OT Visual Composer', 'namos' ), // The plugin name.
            'slug'               => 'ot_composer', // The plugin slug (typically the folder name).
            'source'             => esc_url($protocol.'://oceanthemes.net/plugins-required/namos/ot_composer.zip'), // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(            
            'name'               => esc_html__( 'OT Portfolio', 'namos' ), // The plugin name.
		...
		array(
            'name'               => esc_html__('WPBakery Visual Composer', 'namos'), // The plugin name.
        ...
        array(            
            'name'               => esc_html__( 'OT One Click Import Demo', 'namos' ), // The plugin name.
