<?php
/*
    Plugin Name: Namos Visual Composer
    Plugin URI: http://oceanthemes.net/
    Description: Namos Visual Composer is Child of WPBakery Visual Composer, require install plugin WPBakery Visual Composer.
    Version: 1.0
    Author: OceanThemes
